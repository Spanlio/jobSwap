        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-900">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">{{ __('Owner') }}</th>
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                @foreach ($logs as $log)
                    <tr>
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">#{{ $log->post_id }}</td>
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $log->user?->handle }}</td>
